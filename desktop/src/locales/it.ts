/** Italian catalogue. Keys are the English source strings (see ../i18n.ts). */
const it: Record<string, string> = {
  // generic
  Language: 'Lingua',
  'Selector priority — the runner tries these recorded selectors in this order':
    'Priorità dei selettori — il runner prova i selettori registrati in questo ordine',
  'Use this selector': 'Usa questo selettore',
  'General selector (CSS)': 'Selettore generale (CSS)',
  Text: 'Testo',
  ...
  Code: 'Codice',
  Apply: 'Applica',
  'Delete step': 'Elimina passo',
  'Add step': 'Aggiungi passo',
  'Click a step to edit its action and selectors.': 'Clicca un passo per modificarne azione e selettori.',
  'Unsaved changes': 'Modifiche non salvate',
  disabled: 'disabilitato',
  'Move up': 'Sposta su',
  'Move down': 'Sposta giù',
  'This test uses the older recording format: re-import it (--update) to edit its steps here.':
    'Questo test usa il vecchio formato di registrazione: reimportalo (--update) per modificarne i passi qui.',
  'Free code line: kept as written, not editable with the fields below.': 'Riga di codice libera: resta come scritta, non modificabile con i campi sotto.',
  "The runner tries these in the project's selector priority order; the others are fallbacks.":
    'Il runner li prova nell’ordine di priorità dei selettori del progetto; gli altri sono di riserva.',
  'visible text': 'testo visibile',
  visible: 'visible',
  'Only match visible elements (adds :visible to the CSS selectors)': 'Considera solo gli elementi visibili (aggiunge :visible ai selettori CSS)',
  'Fill in at least one selector, or the step cannot run.': 'Compila almeno un selettore, altrimenti il passo non può girare.',
  Enabled: 'Abilitato',
  'A disabled step is kept but not executed': 'Un passo disabilitato resta salvato ma non viene eseguito',
  'Skip on failure': 'Salta in caso di errore',
  'If the step fails after all retries, carry on with the next one': 'Se il passo fallisce dopo tutti i tentativi, prosegue con il successivo',
  'Timeout (ms)': 'Timeout (ms)',
  'default (8s → 15s → 20s)': 'predefinito (8s → 15s → 20s)',
  'Wait before (ms)': 'Attesa prima (ms)',
  'Causes navigation': 'Provoca navigazione',
  'After the action, wait for the page to load before the next step': 'Dopo l’azione, attende il caricamento della pagina prima del passo successivo',
  'Pick the option by position (number), not by text': 'Scegli l’opzione per posizione (numero), non per testo',
  'Double click': 'Doppio click',
  'Right click': 'Click destro',
  Hover: 'Hover',
  'Type keys': 'Digita tasti',
  Fill: 'Compila',
  Select2: 'Select2',
  Clear: 'Svuota',
  Resize: 'Ridimensiona',
  ...
  'Option (text, or position)': 'Opzione (testo o posizione)',
  Key: 'Tasto',
  URL: 'URL',
